                ...
                case 2:
                    ...
                    while (
                        ...
                        switch(CreatePersonMenuOption)
                        {
                            // Natürliche Person
                            case 1:
                                ConsoleClientController.createPersonWithoutScan("natural");
                                break;
                            // Juristische Person
                            case 2:
                                System.out.println("TODO: Juristische Person anlegen\n");
                                ConsoleClientController.createPersonWithoutScan("legalentity");
                                break;
                            // Systembenutzer
                            case 3:
                                System.out.println("TODO: Systembenutzer anlegen\n");
                                ConsoleClientController.createPersonWithoutScan("user");
                                break;
                            // Zurück
                            case 9:
                                break;
